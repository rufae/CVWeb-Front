...
function ChartContainer({
  ...
  config: ChartConfig;
  children: React.ReactElement | null; // <-- Aquí el cambio
}) {
...
function ChartTooltipContent({
  ...
  const tooltipLabel = React.useMemo<React.ReactElement | null>(() => {
    ...
    if (labelFormatter) {
      ...
      return <div className={cn("font-medium", labelClassName)}>{formatted ?? null}</div>;
    }
...
// Helper para sacar configuración de la carga útil
function getPayloadConfigFromPayload(
  ...
  if (key in payload && typeof payload[key as keyof typeof payload] === "string") {
    ...
    configKey = innerPayload[key as keyof typeof innerPayload] as string;
  }
